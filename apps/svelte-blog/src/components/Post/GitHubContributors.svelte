    ...
    <div class="contributors-list">
      {#each contributors as contributor}
        <a
          ...
          title={`${contributor.login} - ${formatContributions(contributor.contributions)} - 最終編集: ${formatDate(contributor.last_commit_date)}`}
        >
          <img
            src={contributor.avatar_url}
            alt={`${contributor.login}のアバター - ${formatContributions(contributor.contributions)}`}
